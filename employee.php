...
<h2><center>EMPLOYEE</center></h2><hr><br>
<?php
$conn=oci_connect("system","krutika","localhost/orcl");
$stid1 = oci_parse($conn,"select * from employee");
oci_execute($stid1);
echo "<table id='images' border='2'>\n";
echo "<tr><th>EID</th><th>ENAME</th><th>ADDRESS</th><th>EMAIL_ID</th><th>PHONE_NO</th></tr>";
