...
<h2><center>MOVIE 3</center></h2><hr><br>
<?php
$conn=oci_connect("child1","krutika","localhost/orcl");
$stid1 = oci_parse($conn,"select * from movie3");
oci_execute($stid1);
echo "<table id='images' border='2'>\n";
echo "<tr><th>M_ID</th><th>CBFC_RATING</th><th>RATING</th></tr>";
