...
<h2><center>CUSTOMER</center></h2><hr><br>
<?php
$conn=oci_connect("system","krutika","localhost/orcl");
$stid1 = oci_parse($conn,"select * from customer");
oci_execute($stid1);
echo "<table id='images' border='2'>\n";
echo "<tr><th>C_ID</th><th>C_NAME</th><th>EMAIL_ID</th><th>PHONE_NO</th><th>TICKET_NO</th></tr>";
